        ...
        <div className="relative overflow-hidden rounded-2xl bg-zinc-100 text-zinc-900 shadow-2xl">
          ...
          <div className="p-5">
            <div className="grid grid-cols-2 gap-4 text-xs uppercase tracking-wider text-zinc-500">
              <div>
                <div>Name</div>
                <div className="mt-0.5 text-base font-semibold normal-case tracking-normal text-zinc-900">
          ...
          <div className="border-t-2 border-dashed border-zinc-300 px-5 py-3 text-[10px] uppercase tracking-[0.3em] text-zinc-500">
